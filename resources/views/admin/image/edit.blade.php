                ...
                <form action="{{ route('image.update', $image->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="position" id="position" class="form-control @error('position') is-invalid @enderror">
                            ...
                            <option value="home" {{ ($image->position == 'home') ? 'selected' : '' }}>Home</option>
                            <option value="video" {{ ($image->position == 'video') ? 'selected' : '' }}>Video</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <small id="image" class="form-text text-muted">Image dimension: 1593X1062</small>
                    </div>
